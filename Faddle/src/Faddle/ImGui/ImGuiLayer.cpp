...
#define BIND_EVENT_FUNC(x) std::bind(&ImGuiLayer::x, this, std::placeholders::_1)
	...
	void ImGuiLayer::OnEvent(Event& event) {
		...
		dispatcher.Dispatch<MouseButtonReleasedEvent>(BIND_EVENT_FUNC(OnMouseButtonReleasedEvent));
